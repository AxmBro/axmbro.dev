      ...
      <ScreenSection
        ...
        <div>
          <div className="ScreenSectionButtons">
            <RouterLink
              to="https://www.minecraft.net/en-us/marketplace/creator?name=mush%20co" newTab>
              <Button text="Download" buttonColor={"blue"}></Button>
            </RouterLink>
            <RouterLink
              to="https://www.mushco.games/games" newTab>
              <Button text="Mush Co Website" buttonColor={"default"}></Button>
            </RouterLink>
          </div>
        </div>
      </ScreenSection>
        ...
        children={
          <div className="ScreenSectionList" style={{ padding: 0, border: 0 }}>
            <ul>
              ...
              <li key={`2`}>
                Everything rest:{" "}
                <a href="https://www.mushco.games/">Mush Co Team</a>
              </li>
            </ul>
          </div>
        }
